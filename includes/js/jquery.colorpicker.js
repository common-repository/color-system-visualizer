			...
			if (that.element.is('input') || that.options.inline === false) {
				...
				if (/\bbutton|all|both\b/.test(that.options.showOn)) {
					...
					if (that.options.buttonImageOnly && that.image) {
						...
						/*that.button = $('<button type="button" id="button_color"></button>').html(that.image || that.options.buttonText).button();*/
						that.button = $('<button type="button" id="button_color"><span class="dashicons dashicons-admin-customizer"></span></button>')
